...
var serializedLexerAtn = []uint16{
	...
	2, 64, 2, 3, 3, 2, 2, 2, 2, 5, 3, 2, 2, 2, 2, 7, 3, 2, 2, 2, 2, 9, 3, 2,
	...
	33, 3, 2, 2, 2, 13, 35, 3, 2, 2, 2, 15, 37, 3, 2, 2, 2, 17, 40, 3, 2, 2,
	2, 19, 45, 3, 2, 2, 2, 21, 50, 3, 2, 2, 2, 23, 55, 3, 2, 2, 2, 25, 26,
	7, 63, 2, 2, 26, 4, 3, 2, 2, 2, 27, 28, 7, 42, 2, 2, 28, 6, 3, 2, 2, 2,
	29, 30, 7, 43, 2, 2, 30, 8, 3, 2, 2, 2, 31, 32, 7, 44, 2, 2, 32, 10, 3,
	2, 2, 2, 33, 34, 7, 49, 2, 2, 34, 12, 3, 2, 2, 2, 35, 36, 7, 45, 2, 2,
	36, 14, 3, 2, 2, 2, 37, 38, 7, 47, 2, 2, 38, 16, 3, 2, 2, 2, 39, 41, 9,
	2, 2, 2, 40, 39, 3, 2, 2, 2, 41, 42, 3, 2, 2, 2, 42, 40, 3, 2, 2, 2, 42,
	43, 3, 2, 2, 2, 43, 18, 3, 2, 2, 2, 44, 46, 9, 3, 2, 2, 45, 44, 3, 2, 2,
	2, 46, 47, 3, 2, 2, 2, 47, 45, 3, 2, 2, 2, 47, 48, 3, 2, 2, 2, 48, 20,
	3, 2, 2, 2, 49, 51, 7, 15, 2, 2, 50, 49, 3, 2, 2, 2, 50, 51, 3, 2, 2, 2,
	51, 52, 3, 2, 2, 2, 52, 53, 7, 12, 2, 2, 53, 22, 3, 2, 2, 2, 54, 56, 9,
	4, 2, 2, 55, 54, 3, 2, 2, 2, 56, 57, 3, 2, 2, 2, 57, 55, 3, 2, 2, 2, 57,
	58, 3, 2, 2, 2, 58, 59, 3, 2, 2, 2, 59, 60, 8, 12, 2, 2, 60, 24, 3, 2,
	2, 2, 7, 2, 42, 47, 50, 57, 3, 8, 2, 2,
}
...
var lexerSymbolicNames = []string{
	"", "", "", "", "MUL", "DIV", "ADD", "SUB", "NUMBER", "ID", "NEWLINE",
	"WHITESPACE",
}

var lexerRuleNames = []string{
	"T__0", "T__1", "T__2", "MUL", "DIV", "ADD", "SUB", "NUMBER", "ID", "NEWLINE",
	"WHITESPACE",
}
